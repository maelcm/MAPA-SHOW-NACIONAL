...
# Porcentagem de ocupação = reservadas + vendidas sobre total
perc_ocupacao = ((len(reservadas) + len(vendidas)) / total * 100) if total > 0 else 0.0
...
with tab_financeiro:
    ...
    col6.metric("📊 % Ocupação", f"{perc_ocupacao:.1f}%")
    st.divider()
